...
func (m mockRepoFail) Borrow(reqData _entity.Borrow) (code int, err error) {
	return http.StatusInternalServerError, errors.New("internal server error")
}

func (m mockRepoFail) Procure(reqData _entity.Procure) (code int, err error) {
	return http.StatusInternalServerError, errors.New("internal server error")
}

func (m mockRepoFail) GetBorrowById(id int) (req _entity.Borrow, code int, err error) {
	return _entity.Borrow{}, http.StatusInternalServerError, errors.New("internal server error")
}
...
func (m mockRepoFail) UpdateBorrow(reqData _entity.Borrow) (req _entity.Borrow, code int, err error) {
	return _entity.Borrow{}, http.StatusInternalServerError, errors.New("internal server error")
}

func (m mockRepoFail) UpdateProcure(reqData _entity.Procure) (req _entity.Procure, code int, err error) {
	return _entity.Procure{}, http.StatusInternalServerError, errors.New("internal server error")
}

func (m mockRepoFail) GetProcureById(id int) (req _entity.Procure, code int, err error) {
	return _entity.Procure{}, http.StatusInternalServerError, errors.New("internal server error")
}

func (m mockRepoFail) UpdateBorrowByAdmin(reqData _entity.Borrow) (_entity.Borrow, error) {
	return _entity.Borrow{}, errors.New("internal server error")
}

func (m mockRepoFail) ReturnAdmin(reqData _entity.Borrow) (updatedReq _entity.Borrow, code int, err error) {
	return _entity.Borrow{}, http.StatusInternalServerError, errors.New("internal server error")
}

func TestBorrowRepoFail(t *testing.T) {
	t.Run("TestBorrowEmployeeRepoFail", func(t *testing.T) {
		token, _, _ := _midware.CreateToken(1, "Employee")
		...
		requestController := New(mockRepoFail{})
		_midware.JWTMiddleWare()(requestController.Borrow())(context)
	...
	t.Run("TestBorrowAdministratorRepoFail", func(t *testing.T) {
		token, _, _ := _midware.CreateToken(1, "Administrator")
...
func TestProcureRepoFail(t *testing.T) {
	t.Run("TestProcureAdministratorRepoFail", func(t *testing.T) {
		token, _, _ := _midware.CreateToken(1, "Administrator")
...
func TestGetBorrowByIdRepoFail(t *testing.T) {
	t.Run("TestGetBorrowByIdRepoFail", func(t *testing.T) {
		token, _, _ := _midware.CreateToken(1, "Administrator")
...
func TestGetProcureByIdRepoFail(t *testing.T) {
	t.Run("TestGetProcureByIdRepoFail", func(t *testing.T) {
		token, _, _ := _midware.CreateToken(1, "Manager")
...
func TestUpdateBorrowRepoFail(t *testing.T) {
	t.Run("TestUpdateBorrowEmployeeAdminRepoFail", func(t *testing.T) {
		token, _, _ := _midware.CreateToken(1, "Administrator")
	...
	t.Run("TestUpdateBorrowAdminManagerRepoFail", func(t *testing.T) {
		token, _, _ := _midware.CreateToken(1, "Manager")
...
func TestUpdateProcureRepoFail(t *testing.T) {
	t.Run("TestUpdateProcureRepoFail", func(t *testing.T) {
		token, _, _ := _midware.CreateToken(1, "Manager")
...
func TestReturnAdminRepoFail(t *testing.T) {
	t.Run("TestReturnAdminRepoFail", func(t *testing.T) {
		token, _, _ := _midware.CreateToken(1, "Administrator")
