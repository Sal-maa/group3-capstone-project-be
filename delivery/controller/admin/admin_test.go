...
func (m mockRepoSuccess) GetAllProcureManager(limit, offset int, status, category, date, order string) (requests []_entity.Procure, total int, err error) {
...
func TestAdminGetAll(t *testing.T) {
	...
	t.Run("TestAdminGetAllWaitingApprovalSuccess", func(t *testing.T) {
		token, _, _ := _midware.CreateToken(1, "Administrator")

		request := httptest.NewRequest(http.MethodGet, "/?s=waiting-approval", nil)
		request.Header.Set("Content-Type", "application/json")
		request.Header.Set(echo.HeaderAuthorization, fmt.Sprintf("Bearer %s", token))
		request.Header.Set(echo.HeaderContentType, echo.MIMEApplicationJSON)
	...
	t.Run("TestAdminGetAllReturnedSuccess", func(t *testing.T) {
		token, _, _ := _midware.CreateToken(1, "Administrator")

		request := httptest.NewRequest(http.MethodGet, "/?s=returned", nil)
		request.Header.Set("Content-Type", "application/json")
		request.Header.Set(echo.HeaderAuthorization, fmt.Sprintf("Bearer %s", token))
		request.Header.Set(echo.HeaderContentType, echo.MIMEApplicationJSON)
...
func TestManagerGetAllBorrow(t *testing.T) {
	...
	t.Run("TestManagerGetAllReturnedSuccess", func(t *testing.T) {
		token, _, _ := _midware.CreateToken(1, "Manager")
...
func (m mockRepoFail) GetAllProcureManager(limit, offset int, status, category, date, order string) (requests []_entity.Procure, total int, err error) {
...
func TestRepoAdminGetAll(t *testing.T) {
	...
	t.Run("TestRepoAdminGetAllWaitingApprovalFailed", func(t *testing.T) {
		token, _, _ := _midware.CreateToken(1, "Administrator")
	...
	t.Run("TestRepoAdminGetAllReturnedFailed", func(t *testing.T) {
		token, _, _ := _midware.CreateToken(1, "Administrator")
...
func TestRepoGetAllBorrow(t *testing.T) {
	...
	t.Run("TestRepoGetAllReturnedFailed", func(t *testing.T) {
		token, _, _ := _midware.CreateToken(1, "Manager")
